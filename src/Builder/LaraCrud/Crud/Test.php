...
use kallbuloso\Karl\Builder\LaraCrud\Helpers\TestMethod;
...
class Test extends RouteCrud implements Crud
{
    ...
    public function __construct($controller = '', $api = false)
    {
        ...
        $this->suffix = config('karl.laracrud.test.feature.suffix', 'Test');
        $this->namespace = config('karl.laracrud.test.feature.namespace', 'Tests\Feature');
